package com.example.tail.node.service
...
class BackgroundLocationService : Service() {
    ...
    private inner class LocationListener(provider: String?) : android.location.LocationListener {
        ...
        override fun onLocationChanged(location: Location) {
            ...
            onLocationBroadcast(location.latitude, location.longitude)
    ...
    fun onLocationBroadcast(lat: Double, lon: Double) {
        val intent = Intent("onLocationBroadcast")
